...
namespace Agenti
{
    class Program
    {
        private static DBManagerAgenti db = new DBManagerAgenti();
        ...
        private static void VisualizzaAgentiPerAnniDiServizio()
        {
            int anniDiServizio;
        ...
        private static void VisualizzaAgentiPerAreaGeografica()
        {
